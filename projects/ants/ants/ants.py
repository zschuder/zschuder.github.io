...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        dist = 0
        while self.place and (not current_place.is_hive) and dist<=self.upper_bound:
            if current_place.bees and dist>=self.lower_bound:
    ...
    def action(self, gamestate):
        ...
        if self.cooldown>0:
            ...
            if self.place.bees:
                ...
                current_bee.reduce_health(current_bee.health)
